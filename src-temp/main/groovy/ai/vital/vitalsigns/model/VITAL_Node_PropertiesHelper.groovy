...
class VITAL_Node_PropertiesHelper extends ai.vital.vitalsigns.model.ClassPropertiesHelper {

	public VITAL_Node_PropertiesHelper() {
		super('http://vital.ai/ontology/vital-core#VITAL_Node');
	}

	protected VITAL_Node_PropertiesHelper(String propertyURI) {
		super(propertyURI);
	}
	...
	public VitalGraphQueryPropertyCriterion getName() {
