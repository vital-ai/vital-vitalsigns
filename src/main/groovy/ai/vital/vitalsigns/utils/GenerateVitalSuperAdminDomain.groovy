...
public class GenerateVitalSuperAdminDomain {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			DomainGenerator generator = vs.generateDomainClasses(fis, targetSource.toPath(), DomainGenerator.GROOVY, "ai.vital.superadmin.domain");
