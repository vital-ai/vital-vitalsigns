...
class VitalSignsSingleton {
    ...
    private static VitalSignsSingleton instance = null

    public static VitalSignsSingleton get() {

        synchronized (VitalSignsSingleton.class) {

            if (instance != null) { return instance }

            instance = new VitalSignsSingleton()
